...
#define getfpcr() (0)
#define setfpcr(x)
#define MULSL(a,b) "muls.l " #a "," #a ":" #b
#define DIVSL(a,b,c) "divs.l " #a "," #b ":" #c
#define MULSL_CLOBBER
#define DIVSL_CLOBBER
...
static inline void qinterpolatedown16(void *eax, int ecx, int edx, int esi)
{
	...
	asm volatile (
		...
		"bne.b   1b" "\n\t"
		"2:" // end
		: "=r" (_eax), "=r" (_ecx), "=r" (_edx)
		: "r" (_eax), "r" (_ecx), "r" (_edx), "r" (_esi)
		: "d3", "d4", "memory", "cc"
	);
}
...
static inline void qinterpolatedown16short(void *eax, int ecx, int edx, int esi)
{
	...
	register int _esi asm("d2") = esi;
	asm volatile (
		"tst.l   d0" "\n\t" // TODO can this check be skipped?
		"beq.b   3f" "\n\t"
		"moveq   #16,d3" "\n\t"
		"move.l  a0,d4" "\n\t"
		"btst    #1,d4" "\n\t"
