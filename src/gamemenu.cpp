...
void CGameMenuItemSlider::Draw(void)
{
    ...
    if (m_pzText)
        gMenuTextMgr.DrawText(m_pzText, m_nFont, m_nX, m_nY, shade, pal, false);
#ifndef EDUKE32
    int sliderX = m_nX+m_nWidth-1-tilesizx[nSliderTile]/2;
#else
...
#ifndef EDUKE32
    int width = tilesizx[nSliderTile]-8;
#else
    ...
    case kMenuSliderQ16:
        ...
        break;
#ifndef EDUKE32
    case kMenuSliderSensitivity:
        snprintf(buffer, 16, "%.3f ", nValue/32767.f);
        break;
#endif
    }
    int valueWidth;
...
#ifndef EDUKE32
    int valueX = m_nX+m_nWidth-1-tilesizx[nSliderTile]-valueWidth;
#else
...
#ifndef EDUKE32
    const int32_t xscale = divscale16(width, tilesizx[0]<<16), yscale = divscale16(height, tilesizy[0]<<16);
#else
