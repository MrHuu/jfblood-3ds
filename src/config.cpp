...
void CONFIG_SetDefaultKeys(const char (*keyptr)[MAXGAMEFUNCLEN], bool lazy/*=false*/)
{
    ...
    for (int i=0; i < ARRAY_SSIZE(gamefunctions); ++i)
    {
        ...
        int const default1 = KB_StringToScanCode((char *)keyptr[(i<<1)+1]);
#else
...
# endif
    ...
    gSetup.usemouse         = 1;
#ifdef __AMIGA__
    //gSetup.fullscreen       = 0; // TODO remove
#endif
...
int CONFIG_ReadSetup(void)
{
    ...
    SCRIPT_GetNumber(scripthandle, "Options", "MouseAim", &gMouseAim);
    SCRIPT_GetNumber(scripthandle, "Options", "AutoRun", &gAutoRun);
    SCRIPT_GetNumber(scripthandle, "Options", "Interpolation", &gViewInterpolate);
    SCRIPT_GetNumber(scripthandle, "Options", "ViewHBobbing", &gViewHBobbing);
    SCRIPT_GetNumber(scripthandle, "Options", "ViewVBobbing", &gViewVBobbing);
    SCRIPT_GetNumber(scripthandle, "Options", "FollowMap", &gFollowMap);
    SCRIPT_GetNumber(scripthandle, "Options", "OverlayMap", &gOverlayMap);
    SCRIPT_GetNumber(scripthandle, "Options", "RotateMap", &gRotateMap);
    SCRIPT_GetNumber(scripthandle, "Options", "AimReticle", &gAimReticle);
    SCRIPT_GetNumber(scripthandle, "Options", "SlopeTilting", &gSlopeTilting);
    SCRIPT_GetNumber(scripthandle, "Options", "MessageState", &gMessageState);
    ...
    SCRIPT_GetNumber(scripthandle, "Sound Setup", "CDAudioToggle",&CDAudioToggle);
    ...
    SCRIPT_GetNumber(scripthandle, "Controls", "MouseAimingFlipped", &gMouseAimingFlipped);
    SCRIPT_GetNumber(scripthandle, "Controls", "AimingFlag", &gMouseAim);
    ...
    SCRIPT_GetNumber(scripthandle, "Controls", "RunKeyBehaviour", &gRunKeyMode);
...
void CONFIG_WriteSetup(uint32_t flags)
{
    ...
    SCRIPT_PutNumber(scripthandle, "Options", "MouseAim", gMouseAim, false, false);
    SCRIPT_PutNumber(scripthandle, "Options", "AutoRun", gAutoRun, false, false);
    SCRIPT_PutNumber(scripthandle, "Options", "Interpolation", gViewInterpolate, false, false);
    SCRIPT_PutNumber(scripthandle, "Options", "ViewHBobbing", gViewHBobbing, false, false);
    SCRIPT_PutNumber(scripthandle, "Options", "ViewVBobbing", gViewVBobbing, false, false);
    SCRIPT_PutNumber(scripthandle, "Options", "FollowMap", gFollowMap, false, false);
    SCRIPT_PutNumber(scripthandle, "Options", "OverlayMap", gOverlayMap, false, false);
    SCRIPT_PutNumber(scripthandle, "Options", "RotateMap", gRotateMap, false, false);
    SCRIPT_PutNumber(scripthandle, "Options", "AimReticle", gAimReticle, false, false);
    SCRIPT_PutNumber(scripthandle, "Options", "SlopeTilting", gSlopeTilting, false, false);
    SCRIPT_PutNumber(scripthandle, "Options", "MessageState", gMessageState, false, false);
    ...
    SCRIPT_PutNumber(scripthandle, "Sound Setup", "CDAudioToggle",CDAudioToggle,false,false);
    ...
    SCRIPT_PutNumber(scripthandle, "Controls","MouseAim",gMouseAim,false,false);
    ...
    SCRIPT_PutNumber(scripthandle, "Controls","RunKeyBehaviour",gRunKeyMode,false,false);
